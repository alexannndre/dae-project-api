...
public class AuthorizationFilter implements ContainerRequestFilter {
    private static final Response ACCESS_DENIED = Response.status(UNAUTHORIZED).entity("Access denied for this resource").build();
    private static final Response ACCESS_FORBIDDEN = Response.status(FORBIDDEN).entity("Access forbidden for this resource").build();
    ...
    public void filter(ContainerRequestContext requestContext) {
        var methodInvoker = (ResourceMethodInvoker) requestContext.getProperty("org.jboss.resteasy.core.ResourceMethodInvoker");
